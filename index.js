...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Farhan\n'
            + 'ORG:Creator FXC7;\n'
            + 'TEL;type=CELL;type=VOICE;waid=557791174304:+55 779117-4304\n'
            + 'END:VCARD'

prefix = "_"
name = "~ OLAF | B O T"
rdaftar = "OBRIGADO POR SE REGISTRAR😁"
rmenu = "Olá amigos do OLAFBOT👋"
limitt = 50
ban = []
userpremium = ["557791174304@s.whatsapp.net"] //ubah nomer kalian
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Tchauzinho🔥 @${num.split('@')[0]} adeus👋`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
...
const getRegisteredRandomId = () => {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const FarhanGans = ["557791174304@s.whatsapp.net"] // apenas mude esta tudo bem
			...
			const ownerNumber = ["557791174304@s.whatsapp.net"] // owner number ubah aja
		...
		case 'daftar':
			...
			if (isBanned) return reply(mess.only.benned)
				...
				ben = '```Lista dos Banidos``` :\n'
					...
					break 
				case 'premiumlist':
				prem = '```Lista Users Premium  OLAF B O T``` :\n'
           ...
           const imgbb = require('imgbb-uploader')
            ...
            break  
				...
				case 'addprem':
					...
					reply(`*adicionado ${addpremium} ᴜꜱᴇʀ ᴩʀᴇᴍɪᴜᴍ*\n\corno:)`)
					break
				case 'removeprem':
					if (!isOwner) return reply(mess.only.ownerB)
					rprem = body.slice(13)
				...
				case 'unban':
					...
					reply(`haaaa está wa.me/${bnnd}liberto!`)
					break
				case 'block':
				 client.updatePresence(from, Presence.composing) 
         ...
         case 'lirik':
                ...
                if (!isUser) return reply(mess.only.userB)
                    ...
                    client.sendMessage('557791174304@s.whatsapp.net', options, text, {quoted: mek})
				...
				reply(mess.wait)
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Entendeu?'})
					await limitAdd(sender)
					break
				  case 'wa.me':
				  case 'wame':
  client.updatePresence(from, Presence.composing) 
    ...
    client.sendMessage(from, options, text, { quoted: mek } )
				...
				case 'kesia':
					...
					buffer = await getBuffer(`https://uploaddeimagens.com.br/images/003/073/796/original/IMG-20210208-WA0126.jpg?1612797112`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'aii que delícia casa cmg?⛄🔥'})
					break
				case 'jaaw':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://uploaddeimagens.com.br/images/003/073/337/original/IMG-20210208-WA0077.jpg?1612770543`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'moh gostoso aff'})
					break	
				case 'suco':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://uploaddeimagens.com.br/images/003/073/323/original/IMG-20210208-WA0074.jpg?1612763588`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'moh gotosa'})
					break
				case 'olaf1':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0OzC0sDObe2rFZ1zt0vkf8Ie7AIGK1U9Ppw&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Olaf fofo'})
					break
				case 'olaf':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYEobgwg_Fz8UK_ajVWb0qcHmM5xht0PTBYw&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Olaf fofo'})
					break
				case 'olaf3':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDDlHXPXVzg7zju3IvJS-z1bYikzyaDV7vGQ&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Olaf fofo'})
					break
				case 'olaf2':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4HjXCSHCcFgdA-KP5Bp45uY7jd8L9joPIxA&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Olaf fofo'})
					break
				case 'olaf4':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUZkqBJzPpiTZ3b0saYHAdQNyXDu47Ezj2OQ&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Olaf fofo'})
					break
				case 'kong2':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKqhd-HmoixtvTKG3-yV7Ymtr61OXq3jWdxw&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'kong'})
					break
				case 'kong3':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRf-sqYZzxTSBQHG37oZELq7djXLMxBHfOKLA&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'tropa do kong⛄🔥'})
					break
				case 'kong4':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1erSPXvhGv0Q6fhRVAN_Hb12_S5r7TT6C3A&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'tropa do kong⛄🔥'})
					break
				case 'kong5':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDYuGdN2f-3mHv2bQ2Zh2NQxAJSOGHA-_SZw&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'tropa do kong⛄🔥'})
					break
				case 'kong6':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1eG-hhXXvdfnSnqfcG1oBcA6l-wdFsywa3g&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'tropa do kong⛄🔥'})
					break
				case 'kong7':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQN_gCj3Z5KE1A46yGIvJjtmN5V_lPZEYgSeA&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'tropa do kong⛄🔥'})
					break
				case 'kong8':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSyCy9e0EVn4GyNEQ0BFvX4EL54NuzPxuJx4g&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'tropa do kong⛄🔥'})
					break
				case 'olaf5':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTW4RoFfCPJmyn9LmgEFAUL5kraKF0--Qaw0Q&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Olaf fofo'})
					break
				case 'divulgar':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4XYBGosXIWvHOlGc1ke95alMF5vkZdHRWVA&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'link:'})
					break
case 'kong':
		if (args.length < 1) return reply ('tropa do kong caralho')
		break
case 'hentlink':
		if (args.length < 1) return reply ('aqui está o link:https://chat.whatsapp.com/Bvc9VnDTVVz4s3fO8wDCgq')
		break
				case 'memeindo':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				...
				reply(mess.wait)
					...
					break
case 'kong1':
		if (args.length < 1) return reply ('tropa do kong caralho/link:https://youtu.be/l487byOnlKo')
		break 
				case 'memeindo':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				...
				case 'nsfwloli':
				    ...
				    if (isLimit(sender)) return reply(limitend(pushname2))
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'TOME LOLI'})
					} catch (e) {
			    ...
			    case 'nsfwblowjob':
				    ...
				    if (isLimit(sender)) return reply(limitend(pushname2))
						...
						buffer = await getBuffer(res.result)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'SAFADINHO🔥'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply(' *ERROR* ')
					}
				...
				case 'nsfwtrap':
				    ...
				    if (isLimit(sender)) return reply(limitend(pushname2))
						...
						buffer = await getBuffer(res.result)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'SAFADINHO KKKK...'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply(' *ERROR* ')
					}
				...
				case 'hentai':
				    ...
				    if (isLimit(sender)) return reply(limitend(pushname2))
						...
						buffer = await getBuffer(res.result)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'EITA HENTAIZINHO'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply(' *ERROR* ')
					}
                ...
                client.sendMessage(from, buffer, image, {quoted: mek, caption: 'SEU KPOP AI KKKKK...'})
                   break
			    case 'waifu':
...
// only grup fitur anime
              case 'anime':
                ...
                if (!isAnime) return reply(' *Harus Mengaktifkan Mode Anime* ')
					...
					client.sendMessage(from, pok, image, { quoted: mek , caption: 'ANIME😍🔥'})
					await limitAdd(sender) 
					break  
				case 'animekiss':
                if (isBanned) return reply(mess.only.benned)    
...
//akhir kreator
		    ...
		    case 'map':
			    ...
			    if (!isUser) return reply(mess.only.userB)
					...
					mentions(`╔══〘  *${body.slice(12)}*  〙✪══`+teks+'╚═〘 Olaf BOT 〙', members_id, true)
					break
			    case 'kbbi':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
				...
				case 'clearall':
					...
					reply(`\`\`\`Exclua todos os chats com sucesso OlafBOT\`\`\``)
					break
                                case 'bcgc':
					client.updatePresence(from, Presence.composing) 
					if (!isOwner) return reply(mess.only.ownerB)
